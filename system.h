...
/***********************************************************************************************
**
**  Variable type definition: tbar_18
*/
typedef union
{
  unsigned long LWord;
...
/***********************************************************************************************
**
**  Variable type definition: tfifo_bt
*/
typedef struct
{
  byte b_msb;
...
#define  I2C_SDA_PIN     PTBD_PTBD6
#define  I2C_SCL_PIN     PTBD_PTBD7
#define  I2C_SDA_DD      PTBDD_PTBDD6
#define  I2C_SCL_DD      PTBDD_PTBDD7 
...
#define USE_FLASH                   (SystemFlag.Bit._3)
#define CHECK_INT                   (SystemFlag.Bit._2)
#define WINDOW_ACT                  (SystemFlag.Bit._1)
...
*/
//#define STREAM_12C                  (StreamMode.Bit._7)
//#define STREAM_12G                  (StreamMode.Bit._6)
//#define STREAM_8DC                  (StreamMode.Bit._5)
//#define STREAM_8DG                  (StreamMode.Bit._4)
#define PT_STREAM                   (StreamMode.Bit._3)
#define INT_STREAM                  (StreamMode.Bit._2)
//#define STREAM_12C_MASK             (0x80)
//#define STREAM_12G_MASK             (0x40)
#define STREAM_BAR_MASK             (0x20)
#define STREAM_ALT_MASK             (0x10)
//#define STREAM_XYZ_MASK             (0x08)
#define STREAM_INT_MASK             (0x04)
...
enum
{
  FBID_XYZ_SAMPLE = 1,        //  1 = XYZ Sample Registers (0x01 - 0x06)
  FBID_FIFO,                  //  2 = FIFO
  FBID_ALT_INT,               //  3
  FBID_ALT_POLL,              //  4
  FBID_BAR_INT,               //  5
...
#define INT_BOTH_FALLING            (KBIES = 0x00)
#define INT_BOTH_RISING             (KBIES = 0x06)
...
extern void InterruptsActive (void);
